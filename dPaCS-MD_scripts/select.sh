...
trajin ${LOC1}/${try}/${cyc}/candi${i}/md.mdcrd 1 last 25
distance com :28,29,72,73,74,75,148,149,155,156,157,181,185,188,189,191,193 :210,211,212,213,224,225,226,231,232,233,234,235 out ${LOC1}/${try}/${cyc}/candi${i}/select.dat
run
EOF

cpptraj.MPI -i select.in

cat  $LOC1/${try}/${cyc}/candi${i}/select.dat |awk '{printf "'${COMMAND}/../$ran/${try}/${cyc}/candi${i}/' ''%s %s %s\n",$1,$2,$3}'>>$TMPLIST
done
...
parm ${PRE}/1TSRB_ZAFF2.prmtop
trajin $traj/md.mdcrd 1 last 25
trajout ${LOC1}/${try}/${cycp}/candi${i}/${cycp}_cd${i}.rst7 onlyframes $numb
run
eof1
