...
Y, Z = np.meshgrid(y, z)
AYZ = griddata(centers_lcc[:,[1,2]], np.array(A), (Y, Z), method='linear')
# plot the FEL
mpl.rcParams["font.family"]="serif"
fig = plt.figure(figsize=(12,8))
ax = fig.add_subplot(111)
CS = ax.contourf(Y, Z, AYZ, levels=800, origin="upper", cmap=plt.cm.RdYlGn, alpha=1.0)
...
fig.savefig(path+"MSM/FEL_YZ_nclus{}_{}f_no{}_lag{}_Nopathways_DecNo1.png".format(clus,f,n,lt))
