...
X, Y = np.meshgrid(x, y)
AXY = griddata(centers_lcc[:,[0,1]], np.array(A), (X, Y), method='linear')
# plot the FEL
mpl.rcParams["font.family"]="serif"
fig = plt.figure(figsize=(12,8))
ax = fig.add_subplot(111)
CS = ax.contourf(X, Y, AXY, levels=800, origin="upper", cmap=plt.cm.RdYlGn, alpha=1.0)
...
fig.savefig(path+"MSM/FEL_XY_nclus{}_{}f_no{}_lag{}_Nopathways_DecNo1.png".format(clus,f,n,lt))
